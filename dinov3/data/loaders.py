...
from .datasets import ADE20K, CocoCaptions, ImageNet, ImageNet22k, NYU, ThalassaemiaDataset
...
def _parse_dataset_str(dataset_str: str):
    ...
    elif name == "Thalassaemia":
        class_ = ThalassaemiaDataset
        if "split" in kwargs:
            kwargs["split"] = ThalassaemiaDataset.Split[kwargs["split"]]
    else:
